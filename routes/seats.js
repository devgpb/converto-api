...
router.post('/sync', authenticateToken, requireRole(['admin']), validateSeatSync, syncSeats);
...
router.post('/add', authenticateToken, requireRole(['admin']), addSeat);

// POST /api/seats/remove - Remover assento (desativar usuário)
router.post('/remove', authenticateToken, requireRole(['admin']), removeSeat);
